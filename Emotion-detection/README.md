...
- The region of image containing the face is resized to **48x48** and is passed as input to the CNN which looks for the spacial orientation of the images(like person's eyes, the wrinkles while smiling(if any), eyebrows, lips length).
